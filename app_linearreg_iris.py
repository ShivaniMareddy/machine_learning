...
st.set_page_config(page_title="Linear Regression - Iris", layout="centered")
...
st.markdown("""
<div class="card">
    <h1>Linear Regression (Iris Dataset)</h1>
    <p>Predict <b>Petal Length</b> from <b>Sepal Length</b> using Linear Regression</p>
</div>
...
ax.plot(
    df["sepal_length"],
    model.predict(scaler.transform(df[["sepal_length"]])),
    color="red"
)
